...
void MainPanel::scheduleFocusLossHide() {
    if(m_shuttingDown||m_configurationBusy||m_nightLightTransitionActive)return;
    QTimer::singleShot(50,this,[this]{
        if(isVisible() && !m_configurationBusy && !m_nightLightTransitionActive && !QApplication::activePopupWidget())hide();
    });
}
