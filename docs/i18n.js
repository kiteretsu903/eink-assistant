  ...
  const copy = {
    "zh-Hans": {
      ...
      home: {
        ...
        download: "下载 macOS 版 <span aria-hidden=\"true\">↓</span>", star: "喜欢的话，欢迎在 GitHub 点亮 Star。", latest: "最新版本", releaseDate: "2026 年 9 月 1 日", fine: "macOS 14+ · Apple Silicon · 免费开源", tag: "你的墨水屏<br>显示器",
    ...
    "zh-Hant": {
      ...
      home: {
        eyebrow: "<span></span> 專為 macOS 與 Apple 晶片打造", hero: "讓電子紙在 macOS 上<br><em>更穩定、更清晰。</em>", lede: "E-Ink Assistant 是一款輕巧的選單列 App，可改善黑白與彩色電子紙的穩定性、文字顯示與色彩，同時不影響 Mac 內建螢幕。", download: "下載 macOS 版 <span aria-hidden=\"true\">↓</span>", star: "喜歡的話，歡迎在 GitHub 給個 Star。", latest: "最新版本", releaseDate: "2026 年 9 月 1 日", fine: "macOS 14+ · Apple Silicon · 免費開源", tag: "你的電子紙<br>顯示器",
    ...
    ja: {
      ...
      changelog: { intro: ["更新履歴", "何が変わったか、<br><em>いつ変わったか。</em>", "最新バージョンから初回リリースまで、E‑Ink Assistant の更新を確認できます。"], releases: [["バージョン 2.3", "2026年9月1日", "すべての段階で文字をさらに濃く。", "すべての<strong>テキストコントラスト</strong>設定を強化し、「中」は以前の「強」と同じになりました。", "「強」と「シャープ」は薄い文字をよりはっきり濃くし、「ソリッド」は黒点を大幅につぶして最大限に判別しやすくします。", "強化した「ソリッド」では、コントラストと引き換えに階調と柔らかなアンチエイリアスの縁がより失われます。"], ["バージョン 2.2", "2026年8月14日", "言語切り替えを正しく同期。", "「仕組み」セクションの言語切り替えを修正しました。", "見出しと「詳細を表示 / 閉じる」ボタンもパネルのほかの部分と同時に更新され、前に選んだ言語が残らなくなりました。"], ["バージョン 2.1", "2026年8月14日", "より確実なディスプレイ自動化。", "Mac のロック中にディスプレイの自動制御や終了時の処理を行うと、「ショートカット」の警告が表示されることがあった問題を修正しました。", "名前を明確にした、ロック中にも動作する新しい補助ショートカットを追加しました。アップグレード時に互換性のない v2.0 版を再利用することはありません。", "既存ユーザーは、アップグレード後に一度<strong>ショートカットを追加</strong>を選択してください。その後、以前の補助ショートカットを削除できます。"], ["バージョン 2.0", "2026年8月13日", "カラー電子ペーパーと、画面ごとの調整。", "ディスプレイごとの RGB 調整を追加し、モノクロとカラーの電子ペーパーに対応していることを分かりやすくしました。", "ユーザーが確認した補助ショートカットを使い、透明度と視差効果を安全に減らせるようにしました。", "ディスプレイごとの Night Shift と True Tone 制御、英語・簡体字中国語・繁体字中国語・日本語への対応、Applications フォルダへドラッグしてインストールできる DMG を追加しました。"], ["バージョン 1.1", "", "ディスプレイごとのシステムカラー制御。", "選択したディスプレイだけに適用する Night Shift と True Tone 制御を追加しました。"], ["バージョン 1.0", "", "初回リリース。", "ちらつきの軽減、彩度、テキストコントラスト、映像の暗部補正、詳細なトーンカーブ、保存可能なプリセットを含む、ディスプレイごとの電子ペーパー調整を導入しました。"]], github: ["オープンソース", "気に入りましたか？", "GitHub で E‑Ink Assistant に Star を付ける"] }
    }
  };
