  ...
  const copy = {
    "zh-Hans": {
      ...
      home: {
        ...
        download: "下载 macOS 版 <span aria-hidden=\"true\">↓</span>", star: "喜欢的话，欢迎在 GitHub 点亮 Star。", latest: "最新版本", releaseDate: "2026 年 8 月 14 日", fine: "macOS 14+ · Apple Silicon · 免费开源", tag: "你的墨水屏<br>显示器",
        ticker: "显示更稳定 <b>✦</b> 文字更清晰 <b>✦</b> 暗部更易辨认 <b>✦</b> 色彩更自然 <b>✦</b> 显示更稳定 <b>✦</b> 文字更清晰 <b>✦</b> 暗部更易辨认 <b>✦</b> 色彩更自然 <b>✦</b>",
        introNo: "01 / 专为 macOS 设计", intro: "一款专为<br><em>macOS 与墨水屏</em>打造的显示工具。", introP: ["E-Ink Assistant 是一款适用于 Apple 芯片 Mac 和 macOS 14+ 的菜单栏应用。它只调节你标记为墨水屏的外接显示器，Mac 内建显示屏和其他显示器不受影响。", "核心显示控制无需任何权限，也不会安装独立的后台服务。"],
      ...
      changelog: { intro: ["更新记录", "改了什么，<br><em>何时改的。</em>", "从最新版本到首个版本，查看 E‑Ink Assistant 的更新。"], releases: [["版本 2.1", "2026 年 8 月 14 日", "更可靠的显示器自动化。", "修复了 Mac 锁定时显示器自动化或退出清理可能出现的快捷指令警告。", "新增名称清晰、可在锁定状态运行的辅助指令，升级时不会复用不兼容的 v2.0 版本。", "升级后，现有用户确认一次<strong>添加快捷指令</strong>即可。之后可从快捷指令中移除旧版本。"], ["版本 2.0", "2026 年 8 月 13 日", "彩色墨水屏、逐显示器控制和更清晰的界面。", "新增逐显示器 RGB 控制，并更清楚地说明对黑白与彩色墨水屏的支持。", "通过用户确认的辅助指令，安全控制减少透明度与动态效果。", "新增逐显示器 Night Shift 与 True Tone 控制，提供英语、简体中文、繁体中文和日语，并加入可拖放到“应用程序”的安装器。"], ["版本 1.1", "", "逐显示器系统色彩控制。", "新增仅应用于选定显示器的 Night Shift 和 True Tone 控制。"], ["版本 1.0", "", "首次发布。", "推出逐显示器墨水屏调校，包括减少闪烁、饱和度、文字对比度、视频暗部增强、高级色调曲线和保存的预设。"]], github: ["开源", "喜欢这个项目吗？", "在 GitHub 给 E‑Ink Assistant 一个 Star"] }
    },
    "zh-Hant": {
      lang: "zh-Hant",
      ...
      home: {
        eyebrow: "<span></span> 專為 macOS 與 Apple 晶片打造", hero: "讓電子紙在 macOS 上<br><em>更穩定、更清晰。</em>", lede: "E-Ink Assistant 是一款輕巧的選單列 App，可改善黑白與彩色電子紙的穩定性、文字顯示與色彩，同時不影響 Mac 內建螢幕。", download: "下載 macOS 版 <span aria-hidden=\"true\">↓</span>", star: "喜歡的話，歡迎在 GitHub 給個 Star。", latest: "最新版本", releaseDate: "2026 年 8 月 14 日", fine: "macOS 14+ · Apple Silicon · 免費開源", tag: "你的電子紙<br>顯示器",
      ...
      changelog: { intro: ["更新日誌", "改了什麼，<br><em>何時改的。</em>", "從最新版本到首個版本，查看 E‑Ink Assistant 的更新。"], releases: [["版本 2.1", "2026 年 8 月 14 日", "更可靠的顯示器自動化。", "修正 Mac 鎖定時執行顯示器自動化或結束清理可能出現的捷徑警告。", "新增名稱清楚、可在鎖定狀態執行的輔助捷徑，升級時不會重複使用不相容的 v2.0 版本。", "升級後，現有使用者確認一次<strong>加入捷徑</strong>即可。之後可從捷徑中移除舊版本。"], ["版本 2.0", "2026 年 8 月 13 日", "彩色電子紙、逐顯示器控制和更清晰的介面。", "新增逐顯示器 RGB 控制，並更清楚說明對黑白與彩色電子紙的支援。", "透過使用者確認的輔助捷徑，安全控制降低透明度與動態效果。", "新增逐顯示器 Night Shift 與 True Tone 控制，提供英語、簡體中文、繁體中文和日語，並加入可拖放到「應用程式」的安裝程式。"], ["版本 1.1", "", "逐顯示器系統色彩控制。", "新增僅套用於選定顯示器的 Night Shift 和 True Tone 控制。"], ["版本 1.0", "", "首次發行。", "推出逐顯示器電子紙調校，包括減少閃爍、彩度、文字對比度、影片暗部增強、進階色調曲線和儲存的預設。"]], github: ["開源", "喜歡這個專案嗎？", "在 GitHub 給 E‑Ink Assistant 一個 Star"] }
    },
    ja: {
      lang: "ja",
      ...
      home: {
        ...
        workflow: ["03 / シンプルな使い方", "1つのアプリ。3つの手順。<br><em>他の画面には影響しません。</em>", "ディスプレイを接続", "いつもどおり、モノクロまたはカラーの電子ペーパーディスプレイを接続します。", "電子ペーパーとして登録", "E-Ink Assistant で調整するディスプレイを選びます。他の画面には影響しません。", "用途に合う設定を選ぶ", "読書では文字を濃くし、動画では暗部を明るくします。保存済みの設定を微調整することもできます。"],
        ...
        bottom: ["電子ペーパーをもっと快適に", "電子ペーパーを<br><em>macOS に馴染ませよう。</em>", "無料で、プライバシーを尊重した、毎日使う電子ペーパーのためのアプリです。", "E-Ink Assistant をダウンロード <span aria-hidden=\"true\">↓</span>", "macOS 14+ · Apple Silicon · MIT ライセンス"], footer: ["© 2026 E‑Ink Assistant", "GitHub でソースを見る <span aria-hidden=\"true\">↗</span>"]
      },
      changelog: { intro: ["更新履歴", "何が変わったか、<br><em>いつ変わったか。</em>", "最新バージョンから初回リリースまで、E‑Ink Assistant の更新を確認できます。"], releases: [["バージョン 2.1", "2026年8月14日", "より確実なディスプレイ自動化。", "Mac のロック中にディスプレイの自動制御や終了時の処理を行うと、「ショートカット」の警告が表示されることがあった問題を修正しました。", "名前を明確にした、ロック中にも動作する新しい補助ショートカットを追加しました。アップグレード時に互換性のない v2.0 版を再利用することはありません。", "既存ユーザーは、アップグレード後に一度<strong>ショートカットを追加</strong>を選択してください。その後、以前の補助ショートカットを削除できます。"], ["バージョン 2.0", "2026年8月13日", "カラー電子ペーパー、ディスプレイごとの調整、より分かりやすい画面。", "ディスプレイごとの RGB 調整を追加し、モノクロとカラーの電子ペーパーに対応していることを分かりやすくしました。", "ユーザーが確認した補助ショートカットを使い、透明度と視差効果を安全に減らせるようにしました。", "ディスプレイごとの Night Shift と True Tone 制御、英語・簡体字中国語・繁体字中国語・日本語への対応、Applications フォルダへドラッグしてインストールできる DMG を追加しました。"], ["バージョン 1.1", "", "ディスプレイごとのシステムカラー制御。", "選択したディスプレイだけに適用する Night Shift と True Tone 制御を追加しました。"], ["バージョン 1.0", "", "最初のリリース。", "ちらつきの軽減、彩度、テキストコントラスト、映像の暗部補正、詳細なトーンカーブ、保存可能なプリセットを含む、ディスプレイごとの電子ペーパー調整を導入しました。"]], github: ["オープンソース", "プロジェクトが気に入りましたか？", "GitHub で E‑Ink Assistant に Star を付ける"] }
    }
  };
