  ...
  const copy = {
    ...
    ja: {
      ...
      home: {
        ...
        introNo: "01 / macOS のための設計", intro: "macOS と電子ペーパーの<br><em>表示を整えるツール。</em>", introP: ["E-Ink Assistant は、Apple シリコン搭載 Mac の macOS 14 以降で動作するメニューバーアプリです。電子ペーパーとして登録した外部ディスプレイだけを調整し、Mac の内蔵ディスプレイや他のモニターには影響しません。", "主要な表示調整に権限は不要で、別のバックグラウンドサービスもインストールしません。"],
        ...
        workflow: ["03 / シンプルな使い方", "1つのアプリ、3ステップ。<br><em>他の画面には影響しません。</em>", "ディスプレイを接続", "いつもどおり、モノクロまたはカラーの電子ペーパーディスプレイを接続します。", "電子ペーパーとして登録", "E-Ink Assistant で調整するディスプレイを選びます。他の画面には影響しません。", "用途に合う設定を選ぶ", "読書では文字を濃くし、動画では暗部を明るくします。保存済みの設定を微調整することもできます。"],
