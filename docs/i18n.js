  ...
  const copy = {
    ...
    ja: {
      ...
      home: {
        ...
        bottom: ["電子ペーパーをもっと快適に", "電子ペーパーを<br><em>macOS でもっと快適に。</em>", "無料で、プライバシーを尊重した、毎日使う電子ペーパーのためのアプリです。", "E-Ink Assistant をダウンロード <span aria-hidden=\"true\">↓</span>", "macOS 14+ · Apple Silicon · MIT ライセンス"], footer: ["© 2026 E‑Ink Assistant", "GitHub でソースを見る <span aria-hidden=\"true\">↗</span>"]
      },
