  ...
  const copy = {
    "zh-Hans": {
      ...
      home: {
        ...
        introNo: "01 / 专为 macOS 设计", intro: "专为 macOS 与墨水屏<br><em>打造的显示工具。</em>", introP: ["E-Ink Assistant 是一款适用于 Apple 芯片 Mac 和 macOS 14+ 的菜单栏应用。它只调节你标记为墨水屏的外接显示器，Mac 内建显示屏和其他显示器不受影响。", "可直接选择内置预设，也可根据面板微调并保存曲线。"],
        ...
        mac: ["专为 macOS 打造", "一个菜单栏应用。<br>每台显示器独立控制。", "适用于搭载 Apple 芯片的 macOS 14+，支持黑白与彩色墨水屏。", "阅读与媒体模式", "文字对比度与视频暗部增强分别针对不同内容。", "不影响其他显示器", "每台已标记的墨水屏都保存独立配置。", "自动还原", "退出时还原设置，启动时重新应用。"],
    ...
    "zh-Hant": {
      ...
      home: {
        ...
        introNo: "01 / 為 macOS 設計", intro: "專為 macOS 與電子紙<br><em>打造的顯示工具。</em>", introP: ["E-Ink Assistant 在搭載 Apple 晶片的 macOS 14+ 上作為選單列應用程式執行。它只調整你標記為電子紙的外接顯示器，因此 Mac 內建螢幕與其他顯示器保持原樣。", "可直接選擇內建預設，也可依面板微調並儲存曲線。"],
        ...
        mac: ["專為 macOS 打造", "一個選單列 App。<br>每台顯示器獨立控制。", "適用於搭載 Apple 晶片的 macOS 14+，支援黑白與彩色電子紙。", "閱讀與媒體模式", "文字對比度與影片暗部增強分別適用於不同內容。", "不影響其他顯示器", "每台已標記的電子紙都會儲存獨立設定。", "自動還原", "結束時還原設定，啟動時重新套用。"],
    ...
    ja: {
      ...
      home: {
        ...
        introNo: "01 / macOS のための設計", intro: "電子ペーパーを<br><em>macOS で快適に。</em>", introP: ["E-Ink Assistant は、Apple シリコン搭載 Mac の macOS 14 以降で動作するメニューバーアプリです。電子ペーパーとして登録した外部ディスプレイだけを調整し、Mac の内蔵ディスプレイや他のモニターには影響しません。", "内蔵設定を選ぶか、パネルに合わせてカーブを微調整して保存できます。"],
        ...
        mac: ["macOS のために", "1つのメニューバーアプリ。<br>ディスプレイごとに調整。", "Apple シリコン搭載 Mac の macOS 14 以降に対応。モノクロとカラーの電子ペーパーで使えます。", "読書・メディアモード", "テキストコントラストと映像の暗部補正を内容に合わせて使い分けられます。", "他のディスプレイに影響しない", "登録した電子ペーパーパネルごとに設定を保存します。", "自動で元に戻す", "終了時に変更を戻し、起動時に再適用します。"],
