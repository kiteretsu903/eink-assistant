(() => {
  const copy = {
    "zh-Hans": {
      ...
      changelog: { intro: ["更新记录", "改了什么，<br><em>何时改的。</em>", "从最新版本到首个版本，查看 E‑Ink Assistant 的更新。"], releases: [["版本 2.4", "2026 年 9 月 1 日", "控制面板高度按当前屏幕调整。", "控制面板现在使用菜单栏图标所在屏幕的可见高度。", "内容过长时会滚动，并与程序坞或屏幕底边保持 40 点间距；内容较少时使用自然高度。"], ["版本 2.3", "2026 年 9 月 1 日", "调整文字对比度预设值。", "“中等”使用之前的“强”曲线；“强”“锐利”和“实边”逐档加深。", "“锐利”使用 Gamma 5.00 和 0.10 黑点；“实边”使用 Gamma 6.00 和 0.34 黑点。两者会损失更多灰阶细节，边缘也更硬。"], ["版本 2.2", "2026 年 8 月 14 日", "修复“工作原理”的语言切换。", "更改应用语言后，区段标题和“展开 / 收起”按钮会立即更新。"], ["版本 2.1", "2026 年 8 月 14 日", "更新设置辅助指令。", "辅助指令可在 Mac 锁定时运行，避免断开显示器或清理设置时出现“快捷指令”警告。", "从 v2.0 升级的用户需要添加一次改名后的辅助指令，之后可移除旧指令。"], ["版本 2.0", "2026 年 8 月 13 日", "新增显示控制、语言和 DMG 安装器。", "新增逐显示器 RGB、Night Shift 和 True Tone 控制。", "新增通过用户确认的辅助指令控制“降低透明度”和动态效果。", "新增英语、简体中文、繁体中文和日语。"], ["版本 1.1", "", "新增逐显示器 Night Shift 和 True Tone 控制。", "此更改需要管理员密码并重新连接显示器；退出应用时不会还原。"], ["版本 1.0", "", "首个版本。", "新增减少抖动、饱和度、文字对比度、视频暗部增强、自定义色调曲线、已保存曲线和退出时还原显示设置。"]], github: ["开源", "喜欢这个项目吗？", "在 GitHub 给 E‑Ink Assistant 一个 Star"] }
    },
    "zh-Hant": {
      lang: "zh-Hant",
